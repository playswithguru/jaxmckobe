export default function HomePage() {
  ...
  return (
    ...
    <header className="w-full border-b border-slate-200 bg-white">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-16 px-6 py-12 md:py-16 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
              We help governments, institutions, and enterprises modernize operations through trusted data, scalable systems, and practical execution.
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <a
                href="#capabilities"
                className="rounded-full border border-slate-300 px-7 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:text-slate-900"
              >
                View Capabilities
              </a>
            </div>
          ...
          <div>
            <div className="rounded-[2rem] border border-slate-100 bg-white p-5 shadow-md">
              <div className="space-y-4">
                <div className="rounded-2xl bg-emerald-50 p-5">
                  ...
                  <p className="mt-1 text-sm leading-7 text-slate-700">
                    Digital patient records, clinic workflows, interoperable systems
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-blue-50 p-5">
                  ...
                  <p className="mt-1 text-sm leading-7 text-slate-700">
                    School management, student records, digital learning operations
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-slate-100 p-5">
                  ...
                  <p className="mt-1 text-sm leading-7 text-slate-700">
                    Governance, standards, integration, visibility, and AI readiness
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="border-y border-slate-200 bg-white">
        <div className="mx-auto grid max-w-7xl gap-6 px-6 py-8 md:grid-cols-4">
          <div>
            ...
            <p className="mt-2 text-2xl font-semibold text-slate-950">15+ Years</p>
          </div>
          <div>
            <p className="text-sm uppercase tracking-[0.18em] text-slate-500">
              Core Strength
      ...
      <section id="capabilities" className="mx-auto max-w-7xl px-6 py-20">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950 md:text-5xl">
            Practical consulting at the intersection of business, data, and digital transformation
          </h2>
          <p className="mt-5 text-lg leading-8 text-slate-600">
      ...
      <section id="focus-areas" className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950 md:text-5xl">
              Designed for environments where trust, service delivery, and operational visibility matter most
            </h2>
            <p className="mt-5 text-lg leading-8 text-slate-600">
      ...
      <section id="about" className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <h2 className="mt-4 text-4xl font-semibold leading-tight tracking-tight text-slate-950">
          ...
          >
            ...
            <div className="mt-6 flex items-start gap-5">
              <div className="flex h-24 w-24 shrink-0 items-center justify-center rounded-2xl bg-slate-100 text-2xl font-semibold text-slate-500 ring-1 ring-slate-200">
                TA
              </div>
            ...
            <h2 className="mt-6 text-4xl font-semibold leading-tight tracking-tight text-slate-950">
            ...
            <div className="mt-6 grid gap-3 text-sm text-slate-600">
              ...
              <div className="rounded-2xl bg-white px-4 py-3 ring-1 ring-slate-200">
                Experience spanning healthcare, manufacturing, energy, retail, and enterprise systems
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight">
                Built for institutions that need reliable structure beneath critical operations
              </h2>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 text-base leading-8 text-slate-600">
                ...
                development across healthcare, education, and enterprise operations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="rounded-[2rem] bg-gradient-to-r from-sky-600 to-emerald-600 px-8 py-12 text-white md:px-12">
          ...
          <h2 className="mt-3 max-w-4xl text-4xl font-semibold leading-tight tracking-tight md:text-5xl">
            Whether you are modernizing healthcare systems, strengthening educational
            operations, improving data governance, or preparing for AI, JaxMcKobe can
